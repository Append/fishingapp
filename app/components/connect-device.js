...
export default Ember.Component.extend({
 ...
 //    period: "F000AA43-0451-4000-B000-000000000000"
    ...
    onDisconnect: function(){
    	ble.disconnect(this.deviceId, function(){alert("Succesful disconnect");}, function(reason){alert("on DisconnectERROR: " + reason);});
    },
	...
	onConnect: function(deviceId, newThis) {
		...
		ble.startNotification(deviceId, "F000AA40-0451-4000-B000-000000000000", "F000AA41-0451-4000-B000-000000000000", function(data){newThis.get('onBarometerData')(data,newThis)}, function(reason){alert("startNot ERROR: " + reason);});
		...
		function() { alert("Started barometer."); }, function(reason){alert("write onConnect ERROR: " + reason);});
	...
	setup: function(deviceId,newThis){
        ble.connect(deviceId, newThis.get('onConnect')(deviceId, newThis), function(reason){alert("setup ERROR: " + reason);});
	},
